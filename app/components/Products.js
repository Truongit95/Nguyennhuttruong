...
constructor(props){
    ...
    this.itemsRef = root.child('Brand/'+this.props.passProps.brandname+'/Products')
...
componentWillMount(){
    this.itemsRef.on('value',(dataSnapShot)=>{
        dataSnapShot.forEach((child)=>{
         ...
         this.setState({
                    dataSource: this.state.dataSource.cloneWithRows(arrProducts)
                })
                arrProducts = []
    })
}
            ...
            <View style={styles.row}>
                <View style={styles.square}>
                    <TouchableOpacity style={styles.productsImage}
                        ...
                        property.color,property.price, property.des,this.props.passProps.brandname)}>
    ...
    viewDetail(name, image, color, price, des, brandname){
        this.props.navigator.push({
            component: require('./Details'),
            props: {productName: name,image: image, color: color, price:price, des: des, brandname: brandname}
        })
    }
            ...
            <View style={styles.container}>
                <View style={styles.bar}>
                    ...
                    <View style={styles.title}>
                        <Text style={styles.titleText}>{this.props.passProps.brandname}</Text>
                    </View>
